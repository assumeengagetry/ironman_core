...
//========================USEFUL VARIABLES=============================
int UTC = 9; // UTC = value in hour (SUMMER TIME) [For example: Paris UTC+2 => UTC=2]
int Display_backlight = 7; // Adjust it 0 to 7
int led_ring_brightness = 255; // Adjust it 0 to 255
int led_ring_brightness_flash = 255; // Adjust it 0 to 255
